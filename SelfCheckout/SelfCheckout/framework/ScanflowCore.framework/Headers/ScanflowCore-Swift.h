...
SWIFT_CLASS("_TtC12ScanflowCore17ScanflowARManager")
@interface ScanflowARManager : CameraPermissionManager
...
@interface ScanflowARManager (SWIFT_EXTENSION(ScanflowCore)) <ARSCNViewDelegate, ARSessionDelegate>
///
